...
async function createItem(event) {
   ...
   let formInfo =  createFormEntity(event);
   let allInputs = event.target.querySelectorAll("input");
    allInputs.forEach((x) => (x.disabled = true));
   let response = await post("data/catalog",formInfo);
   showDashboard();
}